...
describe('DatabaseManager', () => {
  ...
  describe('initialization', () => {
    ...
    it('should run pending migrations on initialization', async () => {
      await dbManager.initialize()
    ...
    it('should create triggers for FTS sync', async () => {
      await dbManager.initialize()
    ...
    it('should create backup before running migrations', async () => {
      ...
      // Should have created pre-migration backup if migrations were run
      const migrationRunner = dbManager.getMigrationRunner()
  ...
  describe('re-initialization', () => {
    it('should not re-run migrations on second initialization', async () => {
      ...
      const migrationRunner = dbManager.getMigrationRunner()
      const historyAfterFirst = migrationRunner.getMigrationHistory()
      ...
      const migrationRunner2 = dbManager2.getMigrationRunner()
      const historyAfterSecond = migrationRunner2.getMigrationHistory()
  ...
  describe('error handling', () => {
    ...
    it('should throw error if accessing migration runner before initialization', () => {
      expect(() => dbManager.getMigrationRunner()).toThrow(
        'MigrationRunner not initialized'
      )
    })

    it('should throw error if accessing backup manager before initialization', () => {
      expect(() => dbManager.getBackupManager()).toThrow('BackupManager not initialized')
    })
  })
})
