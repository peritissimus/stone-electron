...
import { useShortcuts, type ShortcutAction } from '@renderer/features/settings/hooks/useShortcuts';
import { useWorkbenchCommands } from '@renderer/services/view-state/hooks/useWorkbenchCommands';
import { toSettings, useNavigateHome } from '@renderer/services/navigation';
