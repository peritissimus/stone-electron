...
import { useUIStore, ACCENT_COLORS } from '@renderer/services/view-state/model/uiStore';
...
import type {
  ...
  EditorMode,
  SidebarPanel,
} from '@renderer/services/view-state/model/uiStore';
...
export type { AppPage as ActivePage } from '@renderer/services/navigation/useAppNavigation';
