...
import { useWorkbenchCommands } from '@renderer/services/view-state/hooks/useWorkbenchCommands';
import { useWorkspaces } from '@renderer/services/workspace/hooks/useWorkspaces';
...
export function WorkspaceSelectorHeader() {
  ...
  const { toggleSidebar } = useWorkbenchCommands();
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center size-6 rounded hover:bg-muted/60 transition-[background-color,scale] duration-150 ease-out active:scale-[0.96]"
