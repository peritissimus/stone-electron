...
import { useAskNotesPanelState } from '@renderer/services/view-state/hooks/useAskNotesPanelState';
import { useAskNotes } from '@renderer/features/ai/hooks/useAskNotes';
import { useNavigateToNote } from '@renderer/services/navigation';
import { SourceCitationList } from './SourceCitationList';

export function AskNotesPanel() {
  const { open: askNotesOpen, close: closeAskNotes } = useAskNotesPanelState();
      ...
      <DialogPrimitive.Portal>
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 py-3">
            <Sparkle size={18} weight="fill" className="shrink-0 text-primary" />
            <input
              ref={inputRef}
              type="text"
