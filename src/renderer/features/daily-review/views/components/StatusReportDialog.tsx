...
import { ArrowClockwise, CircleNotch, Copy, PaperPlaneTilt, Warning } from '@phosphor-icons/react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function StatusReportDialog() {
  const { open, generating, sending, result, error, close, regenerate, sendToJournal } =
    useStatusReport();
