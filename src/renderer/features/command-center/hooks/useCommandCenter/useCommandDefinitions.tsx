...
import { useSettingsStore } from '@renderer/features/settings/model/settingsStore';
import { useNoteStore } from '@renderer/features/notes/model/noteStore';
import { useCommandStore } from '@renderer/features/command-center/model/commandStore';
import type { CommandDefinition } from '@renderer/features/command-center/model/commandStore';
...
import {
  ...
  useActiveNoteId,
  useNavigateHome,
} from '@renderer/services/navigation';
...
import { useTemplatesStore } from '@renderer/features/templates/model/templatesStore';
