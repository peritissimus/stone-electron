...
import { useTemplates } from '@renderer/features/templates/hooks/useTemplates';
    ...
    return (
      <div className="px-1 py-4">
        <Body size="sm" variant="muted">
          No templates yet. Stone seeds a starter pack when you activate a workspace — if you're
          seeing this, the workspace folder is locked or the seed failed.
        </Body>
      </div>
    );
  }
