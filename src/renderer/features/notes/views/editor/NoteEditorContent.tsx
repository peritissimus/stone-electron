...
import { RichTextEditorContent, type RichTextEditor } from '@renderer/features/notes/editor';
import { Skeleton } from '@renderer/components/base/ui/skeleton';
import { useEditorUI } from '@renderer/services/view-state/hooks/useUI';
import { useEditorConfig } from '@renderer/features/settings/hooks/useEditorConfig';
