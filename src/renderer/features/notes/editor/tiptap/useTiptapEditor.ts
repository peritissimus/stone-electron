 ...
 *
 * App-facing renderer code imports this through `@renderer/features/notes/editor` so TipTap
 * remains replaceable behind one boundary.
 */

import { useEffect, useRef } from 'react';
import { useEditor } from '@tiptap/react';
import { useNoteCache } from '@renderer/features/notes/hooks/useNoteCache';
import { useEditorConfigStore } from '@renderer/features/settings/model/editorConfigStore';
import { useShortcutsStore } from '@renderer/features/settings/model/shortcutsStore';
import { resolveShortcuts } from '@shared/utils/shortcuts';
import { buildEditorExtensions } from '@renderer/features/notes/editor/config/buildExtensions';
import { preloadConfiguredLanguages } from '@renderer/features/notes/editor/config/codeLanguages';
