...
import { useAISettings } from '@renderer/features/settings/hooks/useAISettings';
    ...
    >
      <ContainerStack gap="lg">
        ...
        <ContainerStack gap="sm">
          ...
          <SettingRow title="Text generation" description="provider/model — pick or type">
            <Combobox
          ...
          <SettingRow title="Embeddings" description="Runs locally (bge-small-en-v1.5), no setup">
            <Badge variant="secondary" className="font-mono text-[10px]">
              Local
            </Badge>
          </SettingRow>
          <SettingRow title="Reranker" description="Runs locally, no setup">
            <Badge variant="secondary" className="font-mono text-[10px]">
              Local
            </Badge>
          </SettingRow>
          <SettingRow title="OpenAI base URL" description="Optional. Blank uses api.openai.com">
            <Combobox
