...
import { useMeetingsSettings } from '@renderer/features/meetings/hooks/useMeetingsSettings';
...
export function RecordingSettings() {
  ...
  return (
    <ContainerStack gap="xl">
      <SettingsSection title="Permissions" description="For meeting recordings and voice notes.">
        <DevicePermissions />
      </SettingsSection>
