...
import { TopicRow } from '@renderer/features/topics/views/components/TopicRow';
import { NoteRow } from '@renderer/features/topics/views/components/NoteRow';
import { TopicNotesPanel } from '@renderer/features/topics/views/components/TopicNotesPanel';
import { CreateTopicDialog } from '@renderer/features/topics/views/components/CreateTopicDialog';
...
function PageHeader({ indexedPercent, reconciling, onCreate, onReconcile }: PageHeaderProps) {
  const pillState =
    indexedPercent === null
