...
export const notebookAPI = {
   ...
   * Get all notebooks
   */
  getAll: (params?: GetAllNotebooksParams): Promise<IpcResponse<{ notebooks: NotebookWithCount[] }>> =>
  ...
  create: (data: {
    ...
    invokeIpc(NOTEBOOK_CHANNELS.CREATE, data),
  ...
  update: (
    ...
    invokeIpc(NOTEBOOK_CHANNELS.UPDATE, { id, ...data }),
