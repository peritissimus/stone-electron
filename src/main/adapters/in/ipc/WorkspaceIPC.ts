...
export function registerWorkspaceHandlers(deps: WorkspaceIPCDeps): void {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.CREATE, async (_event, rawRequest) => {
    ...
    return handleRequest<WorkspaceResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.GET_ALL, async () => {
    return handleRequest<ListWorkspacesResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.GET_ACTIVE, async () => {
    return handleRequest<GetActiveWorkspaceResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.SELECT_FOLDER, async (_event, rawRequest) => {
    ...
    return handleRequest<SelectFolderResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.GET_DEFAULT_PATH, async () => {
    return handleRequest<DefaultWorkspacePathResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.VALIDATE_PATH, async (_event, rawRequest) => {
    ...
    return handleRequest<ValidatePathResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.CREATE_FOLDER, async (_event, rawRequest) => {
    ...
    return handleRequest<FolderPathResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.SCAN, async (_event, rawRequest) => {
    ...
    return handleRequest<ScanWorkspaceResponse>(
      async () => {
  ...
  ipcMain.handle(WORKSPACE_CHANNELS.SYNC, async (_event, rawRequest) => {
    ...
    return handleRequest<SyncWorkspaceResponse>(
      async () => {
