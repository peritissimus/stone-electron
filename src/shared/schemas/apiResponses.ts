/** Shared Effect Schema-backed IPC response schemas. */
...
export { NoteSchema, NoteWithMetaSchema } from './notes';
...
export { NotebookSchema, NotebookWithCountSchema } from './notebooks';
...
export { TodoItemSchema } from './notes';
...
export const AppearanceSettingsSchema = z.object({
  theme: z.literalEnum(['light', 'dark', 'system']),
...
export const AIProviderKeyStatusSchema = z.object({
  provider: z.literalEnum(['openai', 'azure', 'google', 'groq']),
  label: z.string(),
  envVar: z.string(),
  hasEnvKey: z.boolean(),
  hasStoredKey: z.boolean(),
  available: z.boolean(),
  activeSource: z.literalEnum(['env', 'stored']).nullable(),
});
...
export const SearchResultSchema = z.object({
  ...
  search_type: z.literalEnum(['fts', 'semantic', 'hybrid']).optional(),
...
export const GitSyncResultSchema = z.object({
  ...
  errorKind: z.literalEnum(['auth', 'network', 'conflict', 'unknown']).optional(),
  error: z.string().optional(),
});
...
// Graph schemas are defined once in graph.ts.
export {
  GraphNodeSchema,
  GraphLinkSchema,
  GraphLinkSchema as GraphEdgeSchema,
  GraphDataSchema,
} from './graph';
